...
export function Select({ className, ...props }: React.SelectHTMLAttributes<HTMLSelectElement>) {
  return (
    <select
      className={cn(
        'h-10 w-full appearance-none rounded-2xl border border-white/70 bg-white/80 px-3 pr-9 text-sm text-muted focus-visible:ring-2 focus-visible:ring-accent-strong',
